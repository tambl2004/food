            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <svg class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="pt-2 pb-3 space-y-1">
            @php
                ...
                $classes = $active
                    ...
                    : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:hover:border-gray-600 transition duration-150 ease-in-out';
            @endphp
            <a href="{{ route('dashboard') }}" class="{{ $classes }}">
                {{ __('Dashboard') }}
            </a>
            ...
            <div class="mt-3 space-y-1">
                @php
                    ...
                    $classes = $active
                        ...
                        : 'block w-full ps-3 pe-4 py-2 border-l-4 border-transparent text-start text-base font-medium text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-800 dark:focus:text-gray-200 focus:bg-gray-50 dark:focus:bg-gray-700 focus:border-gray-300 dark:hover:border-gray-600 transition duration-150 ease-in-out';
                @endphp
                <a href="{{ route('profile.edit') }}" class="{{ $classes }}">
                    {{ __('Profile') }}
                </a>
