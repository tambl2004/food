...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Thêm nguyên liệu mới</h2>
            <p class="text-gray-600 mt-1">Nhập thông tin nguyên liệu và dinh dưỡng</p>
        </div>
        <div>
    ...
    <form method="POST" action="{{ route('admin.ingredients.store') }}" class="space-y-6">
        @csrf
